      ...
      <div class="compare-container">
        ...
        >
          <div class="panel-header" v-if="accountDataList[index] && accountDataList[index].accountData && accountDataList[index].equip">
            <h3>链接{{ index + 1 }}：{{ accountDataList[index].equip.status_desc }}  {{ accountDataList[index].equip.area_name }}  {{ accountDataList[index].equip.server_name }} </h3>
            <el-button 
              type="danger" 
              size="small" 
          ...
          <div class="panel-content">
            <el-tabs v-model="activeTabs[index]" class="tabs-assort" v-if="accountDataList[index]">
              <el-tab-pane label="武将" name="first">
                <CategoryCards :ref="el => setRef('categoryCards', index, el)" />
              </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    async fetchAccountData(link) {
      ...
      console.log('缓存数据成功', this.accountDataList);
