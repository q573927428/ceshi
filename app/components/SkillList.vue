  ...
  <section class="skill-page">
    <div class="toolbar">
      <div class="toolbar-heading">
        <el-input v-model="query" clearable placeholder="搜索技能名 / 效果 / 标签" class="search-input" :prefix-icon="Search" />
