<template>
  <section class="skill-page">
    <div class="search-row"><el-input v-model="query" clearable placeholder="搜索技能名 / 效果 / 标签" :prefix-icon="Search" /><SkillSpecialStatusGuide /></div>
    <div class="filters">
